...
<main>
  <section class="container my-5">
    ...
    <p>Company Name: TheGCTCorner</p>
    <p>Address: Thegctstreet 1</p>
    <p>Telephone: +41 00 000 00 00</p>
    <p>Email: info@thegctcorner.ch</p>
    <p>Managing Director: Gabriel Franz</p>
    <h2 class="my-4">Legal Disclaimer</h2>
    <p>The information contained in this website is for general information purposes only. The information is provided by TheGCTCorner and while we endeavour to keep the information up to date and correct, we make no representations or warranties of any kind, express or implied, about the completeness, accuracy, reliability, suitability or availability with respect to the website or the information, products, services, or related graphics contained on the website for any purpose. Any reliance you place on such information is therefore strictly at your own risk.</p>
